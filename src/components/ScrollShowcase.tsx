...
const slides: Slide[] = [
  {
    ...
    sublabel: "Public Reddit profiles inspected across active communities",
  },
  {
    number: 8,
    suffix: "M+",
  ...
  },
  {
    ...
    sublabel: "Run profile checks any time and get instant results",
  },
];
